...
#Region "groupby-property"
        ...
        Dim wordGroups = From w In words Group w By __groupByKey2__ = w(0) Into g = Group Select New With {Key .Firstletter = __groupByKey2__, Key .Words = g}
...
#Region "groupby-category"
        ...
        Dim orderGroups = From p In products Group p By __groupByKey3__ = p.Category Into g = Group Select New With {Key .Category = __groupByKey3__, Key .Products = g}
...
#Region "nested-groupby"
        ...
        Dim customerOrderGroups = From c In customers Select New With {Key .CompanyName = c.CompanyName, Key .YearGroups = From o In c.Orders Group o By __groupByKey4__ = o.OrderDate.Year Into yg = Group Select New With {Key .Year = __groupByKey4__, Key .MonthGroups = From o In yg Group o By __groupByKey5__ = o.OrderDate.Month Into mg = Group Select New With {Key .Month = __groupByKey5__, Key .Orders = mg}}}
