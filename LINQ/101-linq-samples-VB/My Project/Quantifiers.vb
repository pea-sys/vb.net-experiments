...
#End Region
        ...
        '            Dim productGroups = From p In products Group p By __groupByKey1__ = p.Category Into g = Group Select (__groupByKey1__, g)
...
#End Region
        ...
        '#Region "all-grouped"
        '            Dim products As List(Of Product) = GetProductList()
        '            Dim productGroups = From p In products Group p By __groupByKey2__ = p.Category Into g = Group Select (__groupByKey2__, g)
